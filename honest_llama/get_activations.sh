CUDA_VISIBLE_DEVICES=3 python3 get_activations.py llama2_chat_7B tqa_mc2 --device 0 
CUDA_VISIBLE_DEVICES=3 python3 get_activations.py llama2_chat_7B tqa_gen_end_q --device 0 
